    ...
    public partial class UCThoigianBieu : UserControl
    {
        ...
        void loaddata()
        {
            try
            {
                ...
                dgvthoigian.DataSource = Thoigianhoc.loadthoigianbieucholop();
        ...
        {
            dv = new DataView(Thoigianhoc.loadthoigianbieucholop());
            dgvthoigian.DataSource = dv;
            autocompletestring();
            dv.RowFilter = string.Format("[Lớp] like '%{0}%'", txttimkiem.Text);
        }
